...
public enum ErrorId {
	...
	PASSWORD_DISABLED(11, "Password authentication<br/>has been disabled for this account", false, true),
	;
	// @formatter:on
	...
	public String buildErrorMessage(String correlatorString) {
		...
		if (showCorrelatorIfAvailable && !(errorMessage == null || errorMessage.trim().length() == 0)) {
